package com.koterwong.androidhero.game2048.activity;
...
import com.koterwong.androidhero.game2048.view.GameView;


public class Game2048 extends Activity implements OnClickListener {

    // Activity的引用
    private static Game2048 mGame;
    // 记录分数
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_option:
                Intent intent = new Intent(Game2048.this, ConfigPreference.class);
