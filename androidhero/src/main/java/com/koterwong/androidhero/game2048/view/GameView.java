package com.koterwong.androidhero.game2048.view;
...
import com.koterwong.androidhero.game2048.bean.GameItem;
...
public class GameView extends GridLayout implements OnTouchListener {
    ...
    public void revertGame() {
        ...
        if (sum != 0) {
            Game2048.getGameActivity().setScore(mScoreHistory, 0);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (isMoved()) {
                    addRandomNum();
                    // 修改显示分数
                    Game2048.getGameActivity().setScore(Config.SCROE, 0);
                }
                checkCompleted();
                break;
            default:
    ...
    private void checkCompleted() {
        ...
        if (result == 0) {
            if (Config.SCROE > mHighScore) {
                ...
                editor.apply();
                Game2048.getGameActivity().setScore(Config.SCROE, 1);
                Config.SCROE = 0;
            }
                            ...
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface arg0,
                                    ...
                                    if (mTarget == 1024) {
                                        ...
                                        mTarget = 2048;
                                        Game2048.getGameActivity().setGoal(2048);
                                    } else if (mTarget == 2048) {
                                        editor.putInt(Config.KEY_GAME_GOAL, 4096);
                                        mTarget = 4096;
                                        Game2048.getGameActivity().setGoal(4096);
                                    } else {
                                        editor.putInt(Config.KEY_GAME_GOAL, 4096);
                                        mTarget = 4096;
                                        Game2048.getGameActivity().setGoal(4096);
